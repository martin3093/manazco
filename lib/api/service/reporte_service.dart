...
class ReporteService extends BaseService {
  ...
  Future<Map<MotivoReporte, int>> obtenerEstadisticasReporte(
    String noticiaId,
  ) async {
    try {
      // Usamos el método get heredado de BaseService
      ...
      if (data.containsKey('estadisticas')) {
        ...
        if (stats.containsKey('noticiaInapropiada')) {
          estadisticas[MotivoReporte.noticiaInapropiada] =
              stats['noticiaInapropiada'] as int;
        }

        if (stats.containsKey('informacionFalsa')) {
          estadisticas[MotivoReporte.informacionFalsa] =
              stats['informacionFalsa'] as int;
        }
