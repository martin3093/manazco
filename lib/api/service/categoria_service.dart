  ...
  Future<List<Categoria>> getCategorias() async {
    try {
      ...
      if (data is List) {
        ...
        debugPrint(
          '📄 Primer elemento de muestra: ${categoriasJson.isNotEmpty ? categoriasJson.first : "ninguno"}',
        );
            ...
            if (json != null && json is Map<String, dynamic>) {
              ...
              if (json['id'] != null || json['_id'] != null) {
                ...
                if (json['_id'] != null && json['id'] == null) {
                  json['id'] =
                      json['_id']; // Copiar '_id' a 'id' si solo existe '_id'
                }
                categorias.add(
                  CategoriaMapper.ensureInitialized().decodeMap<Categoria>(
                    json,
                  ),
                );
              } else {
        ...
        try {
          ...
          if (data['id'] != null || data['_id'] != null) {
            ...
            if (data['_id'] != null && data['id'] == null) {
              data['id'] =
                  data['_id']; // Copiar '_id' a 'id' si solo existe '_id'
            }
