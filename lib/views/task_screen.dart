...
import 'package:manazco/helpers/tasks_card_helper.dart';
...
class TaskScreenState extends State<TaskScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          '${AppConstants.tituloAppbar} - Total: ${_tasks.length}',
        ), //Modificacion 3.2
      ),
      body: Container(
                    ...
                    return Dismissible(
                      ...
                      onDismissed: (direction) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(
                              '${AppConstants.tareaEliminada} ${task.titulo}',
                            ),
                          ),
                        );
                      },
  ...
  void _showTaskModal(BuildContext context) {
    ...
    final TextEditingController dateController =
        TextEditingController(); // Controlador para la fecha
              ...
              children: [
                TextField(
                  ...
                  decoration: const InputDecoration(
                    labelText: AppConstants.tituloTarea,
                  ),
                ),
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(
                    labelText: AppConstants.descripcionTarea,
                  ),
                ),
                TextFormField(
                      ...
                      if (titleController.text.isNotEmpty) {
                        try {
                          ...
                          if (context.mounted) {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                content: Text('Error al obtener los pasos'),
                              ),
                            );
                          }
                        }
                ...
                TextFormField(
                  ...
                  onTap: () async {
                    ...
                    if (pickedDate != null) {
                      ...
                      final int numeroDePasos = 2;
                      final updatedSteps = _taskService.obtenerPasos(
                        task.titulo,
                        selectedDate!,
                        numeroDePasos,
                      );
                ...
                if (titleController.text.isNotEmpty &&
                  ...
                  setState(() {
                    _tasks[index] = Task(
                      titulo: titleController.text,
                      tipo:
                          selectedPriority, // Guardar la prioridad seleccionada
                      descripcion: descriptionController.text,
                      fechaLimite: selectedDate!,
                      pasos: stepsController.text.split('\n'),
                    );
