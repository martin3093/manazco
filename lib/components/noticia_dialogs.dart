...
class NoticiaModal {
  static Future<void> mostrarModal({
    ...
    required Function(
      ...
      Map<String, dynamic> noticiaActualizada,
    )
    onSave, // Callback para guardar con noticia actualizada
  }) async {
    ...
    try {
      ...
      if (categoriaSeleccionada != null) {
        bool existeCategoria = categorias.any(
      ...
      if (formKey.currentState!.validate()) {
        try {
          ...
          final noticiaActualizada = {
            ...
            'fuente': fuenteController.text,
            'publicadaEl':
                (fechaSeleccionada ?? DateTime.now()).toIso8601String(),
            'urlImagen': imagenUrlController.text,
            'categoriaId':
                categoriaSeleccionada ?? CategoriaConstantes.defaultCategoriaId,
          };
