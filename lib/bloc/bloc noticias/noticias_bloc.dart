...
import 'package:manazco/bloc/bloc noticias/noticias_event.dart';
import 'package:manazco/bloc/bloc noticias/noticias_state.dart';
...
class NoticiasBloc extends Bloc<NoticiasEvent, NoticiasState> {
  ...
  Future<void> _onFetchNoticias(
    ...
    try {
      ...
      emit(
        NoticiasError(
          'Error al cargar noticias: ${e.toString()}',
  ...
  Future<void> _onAddNoticia(
    ...
    try {
      ...
      emit(
        NoticiasError(
          'Error al agregar noticia: ${e.toString()}',
          statusCode: statusCode,
        ),
      );
    }
  ...
  Future<void> _onUpdateNoticia(
    ...
    try {
      ...
      emit(
        NoticiasError(
          'Error al actualizar noticia: ${e.toString()}',
          statusCode: statusCode,
        ),
      );
    }
  ...
  Future<void> _onDeleteNoticia(
    ...
    try {
      ...
      emit(
        NoticiasError(
          'Error al eliminar noticia: ${e.toString()}',
          statusCode: statusCode,
        ),
      );
    }
  ...
  Future<void> _onFilterNoticiasByPreferencias(
    ...
    try {
      ...
      emit(
        NoticiasError(
          'Error al filtrar noticias: ${e.toString()}',
          statusCode: statusCode,
        ),
      );
    }
